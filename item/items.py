...
LEVEL3_DAGGER = Weapon("Dagger", 4, toHit=3, initiative=-2, grapple=4, bonusDamage=1)
...
LEVEL1_ELVEN_LONG_SWORD = Weapon("Elven Long Sword", 8, toHit=1, metalBreakPoints=-1,
    woundPenalty=-1)
LEVEL2_ELVEN_LONG_SWORD = Weapon("Elven Long Sword", 8, toHit=2, metalBreakPoints=-1,
    woundPenalty=-1)
LEVEL3_ELVEN_LONG_SWORD = Weapon("Elven Long Sword", 8, toHit=3, metalBreakPoints=-1,
...
LEVEL1_DORRAN_CLEAVER = Weapon("Dorran Cleaver", 6, toHit=1, metalBreakPoints=1)
LEVEL2_DORRAN_CLEAVER = Weapon("Dorran Cleaver", 6, toHit=2, metalBreakPoints=1)
LEVEL3_DORRAN_CLEAVER = Weapon("Dorran Cleaver", 6, toHit=3, metalBreakPoints=1,
    meleeDefense=1)
